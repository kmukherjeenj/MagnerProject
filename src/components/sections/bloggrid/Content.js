				...
				<Fragment key={number}>
					{pageNumbers.length > 1 ? (
						<li className={classNames("page-item", { active: activeCondition })}>
							<Link className="page-link" to="#" data-page={number} onClick={this.handleClick}>
								{number}
							</Link>
						</li>
					) : (
						...
						<div className="col-lg-8">
							...
							{pageNumbers.length > 1 ? (
								<ul className="pagination">
									...
									{pageNumbers.length > 1 && this.state.currentPage !== pageNumbers.length ? (
										<li className="page-item">
