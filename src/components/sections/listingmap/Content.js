		...
		return (
			<div className="listing-map-wrapper">
				...
				<div className="listing-main-wrapper">
					{/* Filter Start */}
					<div className={classNames("acr-filter-form", { "d-block": this.state.advancesearch })}>
						<div className="acr-filter-form-header">
							<h4>Filter</h4>
							<div className="close-btn close-dark filter-trigger" onClick={this.advancetoggle}>
								<span />
								<span />
							</div>
						</div>
							...
							<div className="row">
								...
								<div className="col-lg-4 col-md-6">
									<div className="acr-custom-select form-group">
										...
										<Select2
											data={SELECT_DATA.bathroomslist}
											options={{
												placeholder: "Any amount",
											}}
										/>
						...
						<div className="row">
							<div className="col-lg-6 form-group">
								<div className="search-wrapper">
									<input type="text" className="form-control" placeholder="Search locations" name="search" />
							...
							<div className="col-lg-6 form-group text-right">
								<button type="button" className="btn-custom-2 light-grey filter-trigger" onClick={this.advancetoggle}>
									Advanced Search
								</button>
							</div>
						</div>
								...
								<div className="listing">
									<div className="listing-thumbnail">
										...
										<div className="listing-controls">
											...
											<Link to="#" className="fly-to-location" data-lat="-77.020945" data-lng="38.878241">
