						...
						<div className="col-lg-8">
							...
							<article className="post-single">
								<div className="post-meta">
									<span>
										{" "}
										<img src={process.env.PUBLIC_URL + "/assets/img/people/1.jpg"} alt="author" /> <Link to="#">Randy Blue</Link>{" "}
									</span>
									<span>
										{" "}
										<i className="far fa-calendar" /> <Link to="#">March 3, 2020</Link>{" "}
									</span>
									<span>
										{" "}
										<i className="far fa-folder" /> <Link to="#">Real Estate</Link>{" "}
									</span>
									<span>
										{" "}
										<i className="fas fa-hashtag" /> <Link to="#">Rental</Link>, <Link to="#">Flat</Link>{" "}
									</span>
								</div>
								<div className="post-thumbnail">
									<img src={process.env.PUBLIC_URL + "/assets/img/blog/5.jpg"} alt="post" />
								</div>
								<div className="post-content">
									...
									<p>
										...
										<Link to="#">Lorem Ipsum has been the industry's</Link> standard dummy text ever since the 1500s, when an unknown
										printer took a galley of type and scrambled it to make a type specimen book.
									</p>
									<img src={process.env.PUBLIC_URL + "/assets/img/blog/4.jpg"} alt="post" />
									<p>
										Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard
										dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen
									...
									<div className="row">
										<div className="col-md-6">
											<Link to="assets/img/blog/9.jpg" className="gallery-thumb">
												<img src={process.env.PUBLIC_URL + "/assets/img/blog/9.jpg"} alt="post" />
											</Link>
										</div>
										<div className="col-md-6">
							...
							<div className="section section-padding">
								<h4>Related Posts</h4>
								<div className="row">
									{BLOG_DATA.blogblock.slice(0, 2).map((item, i) => (
										<div key={i} className="col-md-6">
											<article className="post single">
												<div className="post-thumbnail">
													<Link to="/blog-single">
														<img src={process.env.PUBLIC_URL + "/" + item.gridimg} alt="blog post" />
													</Link>
												</div>
																...
																<Fragment>
																	...
																	<div className="post-comment-authors-img">
																		{item.usercomment.map((item, i) => (
																			<Link key={i} to="#">
																				{" "}
																				<img src={process.env.PUBLIC_URL + "/" + item.img} alt="comment author" />{" "}
																			</Link>
																		))}
							...
							<div className="comments-list section pt-0">
								<h4>2 Comments</h4>
								<ul>
									{BLOG_DATA.blogcomment.map((item, i) => (
									...
									<div className="row">
										...
										<div className="col-md-12 form-group">
											<div className="custom-control custom-checkbox">
												...
												<label className="custom-control-label fw-400" htmlFor="sendNotifications">
