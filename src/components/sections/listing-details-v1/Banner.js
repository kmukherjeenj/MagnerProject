	...
	return (
		<div className="banner banner-2 slider-no-padding">
			<div className="banner-item">
				<Slider className="banner-slider" ref={sliderRef} {...settings}>
			...
			<div className="acr-arrows">
				<i className="slider-prev fas fa-arrow-left slick-arrow" onClick={previous} />
				<i className="slider-next fas fa-arrow-right slick-arrow" onClick={next} />
			</div>
		</div>
	);
};
