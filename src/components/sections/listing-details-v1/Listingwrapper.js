					...
					<div className="col-lg-8">
						...
						<div className="listing-content">
							...
							<p>
								...
								<Link to="#">Lorem Ipsum has been the industry's</Link> standard dummy text ever since the 1500s, when an unknown printer took a
						...
						<div className="section section-padding pt-0 acr-listing-features">
							...
							<button
								type="button"
								className={classNames("load-more-features btn-custom-2 light-grey btn-block", { "d-none": showmore })}
						...
						<div className="section pt-0 acr-listing-nearby">
							...
							<div className="listing-nearby-item">
								...
								<ul>
									...
									<li>
										<span>
											<b>Insitution of Science and Technology</b> <span>(3.2 km)</span>{" "}
										</span>
										<ul>
											<li className="custom-warning">
												<i className="fas fa-star fa-xs" />
						...
						<div className="sidebar sticky-sidebar">
							<div className="sidebar-widget">
								...
								<form>
									...
									<button type="submit" className="btn-custom primary light btn-block">
										Send Message
									</button>
								</form>
								{/* Contact End */}
